...
export default function AppLogo({ className = "", size = "w-14 h-14" }: AppLogoProps) {
  return (
    <div
      className={`relative ${size} rounded-[28%] overflow-hidden shadow-[0_18px_50px_rgba(59,130,246,0.35)] ${className}`}
    >
      ...
      <div className="absolute inset-0 rounded-[28%] border border-white/10" />
      <div className="absolute -left-10 -top-10 h-24 w-24 rotate-12 bg-white/15 blur-3xl" />
